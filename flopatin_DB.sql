...
--
-- Host: 127.0.0.1    Database: flopatin
-- ------------------------------------------------------
...
CREATE TABLE `users` (
  ...
  KEY `users_lives_in_a_country_idx` (`country_id`),
  CONSTRAINT `users_lives_in_a_country` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `users` VALUES (1,'ale','info@alezvi.com.ar','$2y$10$UoMXCf7S8L66zXe2anOcWewvzi25CyqAGtZL4NNJ5rljARGvCvv8q',1,NULL),(2,'ale2','info2@alezvi.com.ar','$2y$10$EkUxbKeRXwvEIpwLcLkh1ekuYB7FbcB/HnAfCPfN0Y2t5A7nt/Juy',1,'5cfaadb3d6769.png'),(3,'Hola','hola@gmail.com','$2y$10$EuZv2E6G3tPvMre8yRSydO2h1Aqjqy37kN00RpuJgiJBU5UIFdEFq',4,'5cfacbe74b787.png');
...
-- Dump completed on 2019-06-10 14:20:19
